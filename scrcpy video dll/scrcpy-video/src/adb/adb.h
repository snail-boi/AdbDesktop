...
/*
 * PORT: override the adb executable natively, instead of via the ADB env var
 * (which would be inherited by every process the host spawns). Must be called
 * before sc_adb_init(). Pass NULL to fall back to upstream behaviour.
 */
void
